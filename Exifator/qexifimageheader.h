/*
    ** Bugfix Feb. 2014 sig@sigvdr.de
    ** QExifValue::toString() - Motorola style byteorder in unicode (UTF-16) values is not treated properly
    ** QExifImageHeader::write(QIODevice *device) - add 2 bytes to offset for d->exifIfdValues.count()
    ** QExifValue( const QByteArray &value ) - does not make a real copy of QByteArray
*/
/****************************************************************************
    **
...
public:
    ...
    QString toString(QSysInfo::Endian byteOrder = QSysInfo::LittleEndian) const;
...
public:
    ...
    explicit QExifImageHeader(QByteArray *exifData,quint8 exifId = 0xE1);
    ~QExifImageHeader();
    ...
    static QByteArray changeByteOrder(QByteArray text);
    // added by Sig sig@sigvdr.de
private:
    enum PrivateTag
    {
...
//     nur für Fehlersuche
//    QList<QExifImageHeader::ExifExtendedTag> lExifIfdTags;
//    QList<QExifValue > lExifIfdValues;
